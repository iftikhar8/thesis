...
ggplot(all.regions, aes(x=settle.desc, y=count)) + geom_boxplot(aes(settle.desc)) + coord_flip() +scale_x_discrete(limits = rev(levels(all.regions$settle.desc))) + theme_bw()
...
all.regions <- summarize(all.regions , count = sum(settlement/eggs))
ggplot(all.regions, aes(x=source.desc, y=count)) + geom_boxplot(aes(source.desc)) + coord_flip() +scale_x_discrete(limits = rev(levels(all.regions$source.desc))) + theme_bw()
