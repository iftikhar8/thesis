...
years.diversity <- ggplot(community, aes(yeardesc, diversity)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + theme_classic() + labs(x="Year", y="Settlement diversity")
years.richness <- ggplot(community, aes(yeardesc, richness)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + theme_classic() + labs(x="Year", y="Settlement richness")
p.sites <- plot_grid(sites.diversity, sites.richness, labels="AUTO", ncol=2,align ="hv")
p.years <- plot_grid(years.diversity, years.richness, labels="AUTO", ncol=2,align ="hv")
cowplot::ggsave("../../figs/diversity-regions.png",p.sites,b)
ggsave("../../figs/diversity-years.png",p.years)
