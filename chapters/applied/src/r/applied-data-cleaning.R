...
blackcod.2011.reefs <- summarize(group_by(blackcod.2011.data.conn, settle), count = n())
...
diel.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/diel"))
...
diel.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/diel"))
diel.dk.regions <- get_dispersal_distance_regions(diel.data.dk, reefs.id)
rm(diel.data.conn)
rm(diel.data.dk)

ovm.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm"))
...
ovm.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm"))
...
orientate.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/orientate"))
...
orientate.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/orientate"))
orientate.dk.regions <- get_dispersal_distance_regions(orientate.data.dk, reefs.id)
rm(orientate.data.conn)
rm(orientate.data.dk)

ovm.orientate.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-orientate"))
...
ovm.orientate.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-orientate"))
...
diel.orientate.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/diel-orientate"))
...
diel.orientate.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/diel-orientate"))
...
diel.ovm.orientate.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/diel-ovm-orientate"))
...
diel.ovm.orientate.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/diel-ovm-orientate"))
...
diel.ovm.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/diel-ovm"))
...
diel.ovm.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/diel-ovm"))
...
ovm.labrid.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-labrid"))
...
ovm.labrid.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-labrid"))
...
ovm.mullid.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-mullid"))
...
ovm.mullid.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-mullid"))
...
ovm.scarid.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-scarid"))
...
ovm.scarid.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-scarid"))
...
ovm.scorpaenid.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-scorp"))
...
ovm.scorpaenid.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-scorp"))
...
ovm.serranid.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-serranid"))
...
ovm.serranid.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-serranid"))
...
ovm.synodontid.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-synod"))
...
ovm.synodontid.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-synod"))
...
ovm.daily.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-daily"))
...
ovm.daily.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-daily"))
...
ovm.timestep.data.conn <- read_in_connectivity(paste0(prefix,"/chapters/applied/data/model-output/ovm-timestep"))
...
ovm.timestep.data.dk <- read_in_dispersal_kernel(paste0(prefix,"/chapters/applied/data/model-output/ovm-timestep"))
