...
blackcod.2010.reefs <- summarize(group_by(blackcod.2010.data.conn, settle), count = n())
...
blackcod.2009.reefs <- summarize(group_by(blackcod.2009.data.conn, settle), count = n())
...
blackcod.2008.reefs <- summarize(group_by(blackcod.2008.data.conn, settle), count = n())
...
blackcod.2007.reefs <- summarize(group_by(blackcod.2007.data.conn, settle), count = n())
...
blackcod.2006.reefs <- summarize(group_by(blackcod.2006.data.conn, settle), count = n())
...
blackcod.2005.reefs <- summarize(group_by(blackcod.2005.data.conn, settle), count = n())
...
blackcod.2004.reefs <- summarize(group_by(blackcod.2004.data.conn, settle), count = n())
