...
ggplot(solitary.regions, aes(x=settle.desc, y=count)) + geom_boxplot(aes(settle.desc)) + coord_flip() +scale_x_discrete(limits = rev(levels(eliza.middle.regions$settle.desc)))
...
ggplot(eliza.middle.regions, aes(x=settle.desc, y=count)) + geom_boxplot(aes(settle.desc)) + coord_flip() +scale_x_discrete(limits = rev(levels(eliza.middle.regions$settle.desc)))
