...
ovm.plot <- ggplot(data= ovm.data, aes(x=depth, fill=factor(stage))) + geom_violin() + theme_classic() + labs(x="Depth", y="Proportion") + scale_color_discrete(name="Ontogenetic stage") + theme(legend.position = "right") + facet_grid(. ~ stage)
