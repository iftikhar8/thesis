...
scale_shape_manual(values=c(1, 16), labels=c("Known","Unknown"),name="Sites of aggreation") + guides(colour=guide_legend(ncol=3,title.position = "top"),shape=guide_legend(ncol=1,title.position = "top"))
