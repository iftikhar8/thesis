...
blackcod.sr.plot.year <- ggplot(data=blackcod.sr, aes(x=year,y=sr)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + theme_classic() + labs(x="", y="Self-recruitment")
...
blackcod.ss.plot.year <- ggplot(data=blackcod.ss, aes(x=year,y=ss)) +stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + theme_classic() + labs(x="Year", y="Settlement success")
...
blackcod.lr.plot.year <- ggplot(data=blackcod.lr, aes(x=year,y=lr)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") +  labs(x="", y="Local retention") + theme_classic()
...
blackcod.dk.plot.year <- ggplot(data=blackcod.dk, aes(x=year,y=dk)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + theme_classic() + labs(x="Year", y="Dispersal distance (km)")
...
blackcod.metrics.plot <- plot_grid(blackcod.sr.plot + geom_text(data = blackcod.sr.snk.region, aes(x = desc, y=1.05, label = groups)), 
                                   ...
                                   blackcod.dk.plot + geom_text(data = blackcod.dk.snk.region, aes(x = desc, y=1525, label = groups)), labels = c("A", "B", "C", "D"), ncol = 2, nrow=2, align="hv")
