...
passive.ss <- settlementSuccess(passive.conn.regions/eggs)
```
...
diel.ss <- settlementSuccess(diel.conn.regions/eggs)
```
...
ovm.ss <- settlementSuccess(ovm.conn.regions/eggs)
```
...
orientate.ss <- settlementSuccess(orientate.conn.regions/eggs)
```
...
diel.ovm.ss <- settlementSuccess(diel.ovm.conn.regions/eggs)
```
...
diel.ovm.orientate.ss <- settlementSuccess(diel.ovm.orientate.conn.regions/eggs)
```
...
diel.orientate.ss <- settlementSuccess(diel.orientate.conn.regions/eggs)
```
...
ovm.orientate.ss <- settlementSuccess(ovm.orientate.conn.regions/eggs)
```
...
ovm.labrid.ss <- settlementSuccess(ovm.labrid.conn.regions/eggs)
```
...
ovm.mullid.ss <- settlementSuccess(ovm.mullid.conn.regions/eggs)
```
...
ovm.scarid.ss <- settlementSuccess(ovm.scarid.conn.regions/eggs)
```
...
ovm.scorpaenid.ss <- settlementSuccess(ovm.scorpaenid.conn.regions/eggs)
```
...
ovm.synodontid.ss <- settlementSuccess(ovm.synodontid.conn.regions/eggs)
```
...
ovm.serranid.ss <- settlementSuccess(ovm.serranid.conn.regions/eggs)
```
...
ovm.timestep.ss <- settlementSuccess(ovm.timestep.conn.regions/eggs)
```
...
ovm.daily.ss <- settlementSuccess(ovm.daily.conn.regions/eggs)
```
...
ggplot(data=phase1.dk.summary, aes(y=dk.mean, x=model)) + geom_bar(stat = "identity") + geom_linerange(aes(ymin=dk.mean,ymax=dk.mean+dk.sd),width=.1) + coord_flip()+scale_y_continuous(limits = c(0, 500))
...
```{r}
phase1.sr.lm <- lm(sr ~ model, data=phase1.sr)
anova(phase1.sr.lm)
