...
passive.rlr <- relativeLocalRetention(passive.conn.regions[,-18:-19]/eggs)
...
```{r}
names.phase1 <- c("passive","dvm","ovm","ohs","dvm+ovm","dvm+ovm+ohs","ovm+ohs","dvm+ohs")
...
plot.sr <- ggplot(data=sr.data, aes(model,sr, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + labs(x = "", y="Mean self-recruitment (%)") + theme(legend.position = "bottom") + scale_fill_discrete(name="")+guides(fill=guide_legend(nrow=2,byrow=TRUE))
...
plot.ss <- ggplot(data=ss.data, aes(model,ss, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip()+ labs(x = "", y="Mean settlement success (%)") + theme(legend.position = "bottom") + scale_fill_discrete(name="")+guides(fill=guide_legend(nrow=2,byrow=TRUE))
...
plot.lr <- ggplot(data=lr.data, aes(model,lr, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip()+ labs(x = "", y="Mean local retention (%)") + theme(legend.position = "bottom") + scale_fill_discrete(name="")+guides(fill=guide_legend(nrow=2,byrow=TRUE))
...
plot.dk <- ggplot(data=dk.data, aes(model,dk, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + labs(x = "", y="Mean dispersal distance (km)")+ theme(legend.position = "bottom") + scale_fill_discrete(name="") +guides(fill=guide_legend(nrow=2,byrow=TRUE))

plot.all <- plot_grid(plot.sr, plot.lr, plot.ss, plot.dk, labels="AUTO",align='hv')
save_plot("../../figs/conn-metrics.png", plot.all, ncol=2, nrow=2)
```
