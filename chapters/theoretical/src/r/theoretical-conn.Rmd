...
plot.sr <- ggplot(data=sr.data, aes(model,sr, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + labs(x = "", y="Self-recruitment (%)") + theme(legend.position = "none") + scale_fill_discrete(name="")+guides(fill=guide_legend(nrow=2,byrow=TRUE))
...
plot.ss <- ggplot(data=ss.data, aes(model,ss, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip()+ labs(x = "", y="Settlement success (%)") + theme(legend.position = "none") + scale_fill_discrete(name="")+guides(fill=guide_legend(nrow=2,byrow=TRUE))
...
plot.lr <- ggplot(data=lr.data, aes(model,lr, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip()+ labs(x = "", y="Local retention (%)") + theme(legend.position = "none") + scale_fill_discrete(name="")+guides(fill=guide_legend(nrow=2,byrow=TRUE))
...
plot.dk <- ggplot(data=dk.data, aes(model,dk, fill=scenario)) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + labs(x = "", y="Dispersal distance (km)")+ theme(legend.position = "right") + scale_fill_discrete(name="Scenario")

legend <- get_legend(plot.dk + theme(legend.position = "right"))
plot.dk.a <- plot.dk + theme(legend.position = "none")

plot.all <- plot_grid(plot.sr, plot.lr, plot.ss, plot.dk.a, labels="AUTO",align='hv')
plot.legend <- plot_grid(plot.all,legend, rel_widths=c(1,.2))
