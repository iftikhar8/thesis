...
```{r}
names.phase2 <- c("scenario-1","scenario-2","scenario-3","scenario-4","scenario-5","scenario-6","scenario-7")
...
model.levels <- c("passive","passive+va","dvm","ovm","ohs","ohs+va","dvm+ohs","dvm+ovm","dvm+ovm+ohs","ovm+ohs","scenario-1","scenario-2","scenario-3","scenario-4","scenario-5","scenario-6","scenario-7","stage","timestep","daily")
