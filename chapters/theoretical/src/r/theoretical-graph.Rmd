...
connectance.data <- tribble(~scenario, ~model, ~connectance,
                            "behaviour", "passive-surface", graph.passive.surface.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "behaviour", model = "passive", connectance = graph.passive.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "behaviour", model = "ohs-surface", connectance = graph.orientate.surface.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "labridae", connectance = graph.ovm.labrid.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "mullidae", connectance = graph.ovm.mullid.ind$C)
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "pomacentridae", connectance = graph.ovm.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "scaridae", connectance = graph.ovm.scarid.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "serranidae", connectance = graph.ovm.serranid.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "scorpaenidae", connectance = graph.ovm.scorpaenid.ind$C)
```
...
connectance.data <- add_row(connectance.data, scenario = "ovm-strategy", model = "synodontidae", connectance = graph.ovm.synodontid.ind$C)
```
