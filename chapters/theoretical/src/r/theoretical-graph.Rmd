...
diel graph analysis
```{r}
rownames(diel.conn.regions) <- diel.regions$settle.region
graph.diel <- graph_from_adjacency_matrix(diel.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
ovm graph analysis
```{r}
rownames(ovm.conn.regions) <- ovm.regions$settle.region
graph.ovm <- graph_from_adjacency_matrix(ovm.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(orientate.conn.regions) <- orientate.regions$settle.region
graph.orientate <- graph_from_adjacency_matrix(orientate.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.orientate.conn.regions) <- ovm.orientate.regions$settle.region
graph.ovm.orientate <- graph_from_adjacency_matrix(ovm.orientate.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(diel.orientate.conn.regions) <- diel.orientate.regions$settle.region
graph.diel.orientate <- graph_from_adjacency_matrix(diel.orientate.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(diel.ovm.orientate.conn.regions) <- diel.ovm.orientate.regions$settle.region
graph.diel.ovm.orientate <- graph_from_adjacency_matrix(diel.ovm.orientate.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(diel.ovm.conn.regions) <- diel.ovm.regions$settle.region
graph.diel.ovm <- graph_from_adjacency_matrix(diel.ovm.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.labrid.conn.regions) <- ovm.labrid.regions$settle.region
graph.ovm.labrid <- graph_from_adjacency_matrix(ovm.labrid.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.mullid.conn.regions) <- ovm.mullid.regions$settle.region
graph.ovm.mullid <- graph_from_adjacency_matrix(ovm.mullid.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.scarid.conn.regions) <- ovm.scarid.regions$settle.region
graph.ovm.scarid <- graph_from_adjacency_matrix(ovm.scarid.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.serranid.conn.regions) <- ovm.serranid.regions$settle.region
graph.ovm.serranid <- graph_from_adjacency_matrix(ovm.serranid.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.scorpaenid.conn.regions) <- ovm.scorpaenid.regions$settle.region
graph.ovm.scorpaenid <- graph_from_adjacency_matrix(ovm.scorpaenid.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.synodontid.conn.regions) <- ovm.synodontid.regions$settle.region
graph.ovm.synodontid <- graph_from_adjacency_matrix(ovm.synodontid.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.timestep.conn.regions) <- ovm.timestep.regions$settle.region
graph.ovm.timestep <- graph_from_adjacency_matrix(ovm.timestep.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
...
rownames(ovm.daily.conn.regions) <- ovm.daily.regions$settle.region
graph.ovm.daily <- graph_from_adjacency_matrix(ovm.daily.conn.regions[,-18], mode= c("directed"), weighted = TRUE)
