...
Labels for the data
```{r}
model <- c("passive","passive-surface","dvm","ovm","ohs","ohs-surface","dvm+ovm+ohs","ovm+ohs","dvm+ovm","dvm+ohs","pomacentridae","labridae","mullidae","scaridae","scorpaenidae","serranidae","synodontidae","stage","timestep","daily")
...
Metrics graphs
```{r}
model.levels <- c("passive","dvm","ovm","ohs","dvm+ohs","dvm+ovm","dvm+ovm+ohs","ovm+ohs","pomacentridae","labridae","mullidae","scaridae","scorpaenidae","serranidae","synodontidae","stage","timestep","daily")

metrics <- dplyr::select(phase1.community, diversity, richness, behaviour) %>% mutate(scenario = "behaviour")
...
metrics <- metrics %>% full_join(metrics2) %>% full_join(metrics3) %>% gather(key="scenarios",value="model", behaviour, fish, methods) %>% filter(model != "NA")
