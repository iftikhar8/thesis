...
phase1.nmds.plot <- ggplot(MDS_xy, aes(MDS1, MDS2, colour=behaviour, group=sites,fill=behaviour))  + theme_few() + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white", size=3) + scale_fill_manual(name="Behaviour", values = coul)
...
phase1.nmds.plot.norm <- ggplot(phase1.points.norm, aes(MDS1, MDS2, colour=behaviour, group=sites,fill=behaviour))  + theme_few() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white", size=3) + scale_fill_manual(name="Behaviour", values = coul) 
#+ geom_point()
...
phase1.cca.plot <- ggplot(phase1.cca, aes(CAP1, CAP2)) + theme_few() + geom_label_repel(aes(label=behaviour), size=3) + geom_point() + labs(x="CAP1 (25.7% explained)",y="CAP2 (10.4% explained)")
...
phase1.biplot <- fviz_ca_biplot(phase1.ca, map="colgreen", arrow=c(FALSE,TRUE), repel=TRUE, title = "") + theme_few()
...
phase2.nmds.plot <- ggplot(MDS_xy, aes(MDS1, MDS2, colour=fish, group=sites,fill=fish))  + theme_few() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white") + scale_fill_manual(name="OVM strategy", values = coul)
#+geom_polygon(aes(fill=sites))
...
phase2.nmds.plot.norm <- ggplot(phase2.points.norm, aes(MDS1, MDS2, colour=fish, group=sites,fill=fish))  + theme_few() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white") + scale_fill_manual(name="OVM strategy", values = coul)
#+geom_polygon(aes(fill=sites))
...
phase2.cca.plot <- ggplot(phase2.cca, aes(CAP1, CAP2))  + theme_few() + geom_label_repel(aes(label=fish),size=3) + geom_point() + labs(x="CAP1 (30.0% explained)",y="CAP2 (14.4% explained)")
...
phase2.biplot <- fviz_ca_biplot(phase2.ca, map="colgreen", arrow=c(FALSE,TRUE), repel=TRUE, title = "") + theme_few()
...
phase3.nmds.plot <- ggplot(MDS_xy, aes(MDS1, MDS2, colour=methods, group=sites,fill=methods))  + theme_few() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white") + scale_fill_manual(name="OVM method", values = pal)
#+geom_polygon(aes(fill=sites))
...
phase3.nmds.plot.norm <- ggplot(plase3.points.norm, aes(MDS1, MDS2, colour=methods, group=sites,fill=methods))  + theme_few() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white",size=3) + scale_fill_manual(name="OVM Method", values = pal)
#+geom_polygon(aes(fill=sites))
...
phase3.cap.plot <- ggplot(phase3.cca, aes(CAP1, CAP2))  + theme_few() + geom_label_repel(aes(label=methods),size=3) + geom_point() + labs(x="CAP1 (26.9% explained)",  y="CAP2 (13.9% explained)")
...
phase1.plot <- ggdendrogram(phase1.reefs.cluster, theme_dendro = FALSE, rotate=TRUE) + theme_few() + labs(x="Behaviour", y="Bray-Curtis dissimilarity")
...
phase2.plot <- ggdendrogram(phase2.reefs.cluster, theme_dendro = FALSE, rotate=TRUE) + theme_few() + labs(x="OVM Strategies", y="Bray-Curtis dissimilarity")
phase2.plot
...
phase3.plot <- ggdendrogram(phase3.reefs.cluster, theme_dendro = FALSE, rotate=TRUE) + theme_few() + labs(x="OVM Methods", y="Bray-Curtis dissimilarity")
phase3.plot
...
```{r}
pal <- canva_pal("Fresh and energetic")(4)
model.levels <- c("passive","passive+va","dvm","ovm","ohs","ohs+va","dvm+ohs","dvm+ovm","dvm+ovm+ohs","ovm+ohs","pomacentridae","labridae","mullidae","scaridae","scorpaenidae","serranidae","synodontidae","stage","timestep","daily")
...
metrics.plot1 <- ggplot(data=metrics, aes(model, diversity, fill=scenario),na.rm = TRUE) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip() + labs(x = "", y="Settlement diversity")+ theme_few()+theme(legend.position = "none") + scale_fill_manual(name="",values=pal) +guides(fill=guide_legend(nrow=2,byrow=TRUE))

metrics.plot2 <- ggplot(data=metrics, aes(model, richness, fill=scenario),na.rm = TRUE) + stat_summary(fun.data = min.mean.sd.max, geom = "boxplot") + coord_flip()  + labs(x = "", y="Settlement richness")+theme_few()+ theme(legend.position = "none") + scale_fill_manual(name="",values=pal) +guides(fill=guide_legend(nrow=2,byrow=TRUE))

load(file="graph.rda")
connectance.data$model <- factor(connectance.data$model, levels=rev(model.levels))
metrics.plot3 <- ggplot(data=connectance.data, aes(model, connectance, colour=scenario),na.rm = TRUE) + geom_point(size=3) + coord_flip()  + labs(x = "", y="Connectance")+ theme_few()+ theme(legend.position = "right") + scale_colour_manual(name="Scenario",values=pal)
...
phase3.biplot <- fviz_ca_biplot(phase3.ca, map="colgreen", arrow=c(FALSE,TRUE), repel=TRUE, title = "") + theme_few()
...
all.cap.plot <- ggplot(all.cca, aes(CAP1, CAP2, label=models, fill=scenario))  + theme_few()+ theme(legend.position = "bottom")  +geom_label_repel(show.legend = TRUE,size=3, fontface = 'bold', color = 'white',
...
all.nmds.plot <- ggplot(all.ca.data, aes(CA1, CA2, colour=scenario, group=scenario, label=model))  + theme_few() + theme(legend.position = "bottom") + geom_point(size=3) + geom_text_repel(size=4) + scale_colour_discrete(name="Scenario")
