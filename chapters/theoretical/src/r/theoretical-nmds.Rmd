...
data <- as_tibble((passive.surface.conn.regions+1)/(passive.surface.conn.regions+1))
data$sites <- regions
data$behaviour <- rep(c("passive-surface"))
data.passive <- as_tibble((passive.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
data.passive$sites <- regions
data.passive$behaviour <- rep(c("passive"))
data.diel <- as_tibble((diel.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
data.diel$sites <- regions
data.diel$behaviour <- rep(c("dvm"))
data.ovm <- as_tibble((ovm.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
data.ovm$sites <- regions
data.ovm$behaviour <- rep(c("ovm"))
data.orientate.surface <- as_tibble((orientate.surface.conn.regions+1)/(passive.surface.conn.regions[,-18] +1))
data.orientate.surface$sites <- regions
data.orientate.surface$behaviour <- rep(c("ohs-surface"))
data.orientate <- as_tibble((orientate.conn.regions+1)/(passive.surface.conn.regions[,-18] +1))
data.orientate$sites <- regions
data.orientate$behaviour <- rep(c("ohs"))
data.ovm.orientate <- as_tibble((ovm.orientate.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
data.ovm.orientate$sites <- regions
data.ovm.orientate$behaviour <- rep(c("ovm+ohs"))
data.diel.ovm.orientate <- as_tibble((diel.ovm.orientate.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
data.diel.ovm.orientate$sites <- regions
data.diel.ovm.orientate$behaviour <- rep(c("dvm+ovm+ohs"))
data.diel.orientate <- as_tibble((diel.orientate.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
data.diel.orientate$sites <- regions
data.diel.orientate$behaviour <- rep(c("dvm+ohs"))
data.diel.ovm <- as_tibble((diel.ovm.conn.regions+1)/(passive.surface.conn.regions[,-18]+1))
...
#phase1.community <- filter(phase1.community, behaviour=="passive-surface")
...
ggsave("../../figs/phase1-nmds-normal.png",phase1.nmds.plot, scale=1.2)
...
phase1.community_matrix <- dplyr::select(phase1.community, -behaviour, -sites)
phase1.community_matrix[is.na(phase1.community_matrix)] <- 0
phase1.community_matrix <- phase1.community_matrix[,-18:-20]
...
MDS_xy$codes <- rep(c(1:17),10)
phase1.nmds.plot <- ggplot(MDS_xy, aes(MDS1, MDS2, colour=behaviour, group=sites,fill=behaviour))  + theme_bw() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white") + scale_fill_manual(name="Behaviour", values = coul)
ggsave("../../figs/phase1-nmds.png",phase1.nmds.plot, scale=1.2)

phase1.community$latitude <- factor(phase1.community$latitude)
...
cowplot::ggsave("../../figs/phase1-cap.png", phase1.cca.plot)
```
...
phase2.adonis <- adonis(phase2.community_matrix ~ fish + sites, phase2.community, perm=200)
phase2.adonis
