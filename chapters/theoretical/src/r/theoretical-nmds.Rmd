...
phase1.cca.plot <- ggplot(phase1.cca, aes(CAP1, CAP2)) + theme_classic() + geom_label_repel(aes(label=behaviour), size=3) + geom_point() + labs(x="CAP1 (25.7% explained)",y="CAP2 (10.4% explained)")
...
phase2.nmds.plot <- ggplot(MDS_xy, aes(MDS1, MDS2, colour=fish, group=sites,fill=fish))  + theme_classic() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white") + scale_fill_manual(name="OVM strategy", values = coul)
#+geom_polygon(aes(fill=sites))
...
phase2.cca.plot <- ggplot(phase2.cca, aes(CAP1, CAP2))  + theme_classic() + geom_label_repel(aes(label=fish),size=3) + geom_point() + labs(x="CAP1 (30.0% explained)",y="CAP2 (14.4% explained)")
...
phase3.nmds.plot.norm <- ggplot(plase3.points.norm, aes(MDS1, MDS2, colour=methods, group=sites,fill=methods))  + theme_bw() + theme(legend.position = "right") + guides(fill=guide_legend(title.position = "top")) + geom_label(aes(label=codes), fontface="bold", color="white",size=3) + scale_fill_manual(name="OVM Method", values = coul)
#+geom_polygon(aes(fill=sites))
...
phase3.cap.plot <- ggplot(phase3.cca, aes(CAP1, CAP2))  + theme_classic() + geom_label_repel(aes(label=methods)) + geom_point() + labs(x="CAP1 (26.9% explained)",  y="CAP2 (13.9% explained)")
...
save_plot("../../figs/phase1-cluster.png", grid, nrow=2,ncol=2)
```
...
all.cap.plot <- ggplot(all.cca, aes(CAP1, CAP2, label=models, colour=scenario, shape=scenario))  + theme_classic() +geom_label_repel(show.legend = FALSE,size=3) + geom_point(size=2) + labs(x="CAP1 (23.4% explained)", y="CAP2 (12.6% explained)") + scale_color_manual(name="Scenario",values=pal) + scale_shape(name="Scenario")
save_plot("../../figs/all-cap.png", all.cap.plot,ncol=2)
