...
p <- ggplot(ovm, aes(x=depth, y=probability, group=stage, colour=stage)) + geom_line(size=2) + theme_classic()  + labs(x="Depth (m)", y="Proportion") + coord_flip() + theme(legend.title = element_text("none"), legend.position = "bottom")
p <- plot_grid(p)
cowplot::ggsave("../../figs/ovm-example.png",p, width = 5, height=4)
