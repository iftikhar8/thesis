...
ovm.plot <- ggplot(data= ovm.data, aes(x=depth, y=proportion, group=stage, colour=stage)) + geom_line() + geom_point() + facet_wrap(~fish, ncol=2, shrink = TRUE) + coord_flip() + theme_bw() + labs(x="Depth", y="Proportion") + theme(legend.position = "bottom")
