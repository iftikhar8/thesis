...
[Contrasting between the two - what was the same ,what was different. Why would we see differences?]
...
Why differences ?
- Swimming speeds are species specfic (slow siwmmers might hide deep, or perhaps use faster currents at surface), prey selection (prey could be disritubted differntly vertically), ability to see. Overall different strategies seen for different fish .




Two of the families only showed OVM patterns through one of the response variables; Pomacentridae with length and Synodontidae with stage-abundance.
...
Obviously these results could be confounded by species variation within a family.
