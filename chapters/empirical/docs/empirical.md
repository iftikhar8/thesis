...
[Depth patterns]
All three ontogenetic stages of Labridae, Scorpaenidae, and Synodontidae preferred the mid depth layer (@fig:ovm). Pomacentridae, Mullidae, Scaridae and Serranidae occurred in similar abundances in surface waters and the top 50m. Mullidae, Pomacentridae, Synodontidae, Serranidae all had low abundance in the deep later, with only Labridae, Scaridae, and Scorpaenidae occurred in any notable numbers below 50 m.

Five of the seven reef associated families showed significant patterns of ontogenetic vertical migration, Labridae, Mullidae, Scorpaenidae, Serranidae, and Synodontidae, defined as an interaction of stage and depth on the concentration of larval fish (@fig:ovm; @tbl:ontogeny-glm-output).


[Labridae]
The Labridae larvae showed patterns of downwards ontogenetic vertical migration. Labridae larvae were found to be in equal numbers at both the surface and mid-depth (many postflexion larvae were found in the surface but with high variability; @fig:ovm). Preflexion Labridae larvae were in significantly lower numbers than both flexion (p < 0.001) and post-flexion (p < 0.001) at the deepest later, suggesting 50 m is the deepest as the preflexion larvae descend. These preflexion larvae preferred the middle depth, 2.4 times more abundant there than the surface (p = 0.020), and 9.2 times more abundant at 5-50 m than the deep layer (p < 0.001). The preflexion larvae were 3.8 times less abundant in the deep layer than the surface (p = 0.011) Labridae flexion larvae preferred the middle depth over the surface where they were found to be 2.5 times more abundant (p = 0.017). The postflexion larvae did not have a preference for any depth, seemingly expanding their range over the sampled 100 m.

[Mullidae]
At the surface, ontogenetic stages of Mullidae larvae were found to be in equal abundances, however in the middle layer preflexion larvae were 5.3 times more abundant than the postflexion larvae (p = 0.003) and in deep layer they were 9.2 times less abundant (p = 0.045). All three ontogenetic stages for Mullidae larvae were significantly more abundant at the surface and middle depth than the deep depth.

[Scorpaenidae]
Scorpaenidae preflexion larvae were 6 times more abundant than postflexion larvae at the surface (p = 0.044), in equal abundances to the other stages in the middle depth and 5.4 times less abundant then postflexion larvae at the deep depth (p = 0.030; @fig:ovm). Flexion and postflexion larvae were found in equal abundances at each depth, and both were found significantly higher numbers at the middle and deep depths compared to the surface. Preflexion larvae appeared to be more abundant at the surface and middle depths than the deep, but post-hoc tests did not find this to be significant.

[Serranidae]
At the surface and middle depths, each ontogenetic stage of Serranidae larvae occurred in significantly different abundances, preflexion larvae were the most abundant, and postflexion were the least abundant (@fig:ovm). In the deep layer, preflexion and flexion larvae occurred in equal highest abundances, and postflexion was the least abundant. Preflexion and flexion larvae were not found by the model to change in abundance between the depths, which is does not appear to fit the data (@fig:ovm).

[Synodontidae]
Synodontidae preflexion larvae were found in higher abundances in the surfaces, 6.1 times more abundant than postflexion larvae (p = 0.018). In all other depths, the stages occurred in equal abundances, suggesting a preference for preflexion larvae of shallower depths than older larvae which are found 5-100m.
