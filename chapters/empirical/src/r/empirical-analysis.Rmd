...
data.ontogeny.labrid.posthoc.ds1 <- pairs(lsmeans(model.ontogeny.labrid.nb, ~ stage|depth,type="response"))
data.ontogeny.labrid.posthoc.ds2 <- pairs(lsmeans(model.ontogeny.labrid.nb, ~ depth|stage,type="response"))
rbind(data.ontogeny.labrid.posthoc.ds1,data.ontogeny.labrid.posthoc.ds2, adjust="Tukey")

lsmip(model.ontogeny.labrid.nb, stage ~ depth, type="response")
lsmip(lsmeans(model.ontogeny.labrid.nb, ~ depth | stage, cov.reduce=FALSE),stage ~ depth, type="response", ylab="observed")
```
...
data.ontogeny.mullid.posthoc.ds1 <- pairs(lsmeans(model.ontogeny.mullid.nb, ~ stage|depth,type="response"))
data.ontogeny.mullid.posthoc.ds2 <- pairs(lsmeans(model.ontogeny.mullid.nb, ~ depth|stage,type="response"))
rbind(data.ontogeny.mullid.posthoc.ds1,data.ontogeny.mullid.posthoc.ds2, adjust="tukey")
```
...
```{r}
lsmip(lsmeans())
data.ontogeny.scorpaenid.posthoc.ds1 <- pairs(lsmeans(model.ontogeny.scorpaenid.nb, ~ stage|depth,type="response"))
data.ontogeny.scorpaenid.posthoc.ds2 <- pairs(lsmeans(model.ontogeny.scorpaenid.nb, ~ depth|stage,type="response"))
rbind(data.ontogeny.scorpaenid.posthoc.ds1,data.ontogeny.scorpaenid.posthoc.ds2, adjust="Tukey")
