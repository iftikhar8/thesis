...
data.ontogeny <- filter(data.ontogeny, family == "scorpaenidae")
data.length <- filter(data.length, family == "scorpaenidae")
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=depth, fill="red")) + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Depth", y="Concentration", title="scorpaenidae") + theme_classic() + guides(fill="none")
model.ontogeny.depth <- glm.nb(count ~ offset(log(volume)) + depth, data=data.ontogeny)
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=stage, fill="red")) + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Stage", y="Concentration", title="scorpaenidae") + theme_classic() + guides(fill="none")
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=feature, fill="red")) + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Feature", y="Concentration", title="scorpaenidae") + theme_classic() + guides(fill="none")
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=temperature)) + geom_point() + geom_smooth(method=lm) + labs(x="Temperature", y="Concentration", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=salinity)) + geom_point() + labs(x="Salinity", y="Concentration", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=dissolved_oxygen)) + geom_point() + labs(x="Dissolved Oxygen", y="Concentration", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=chlorophyll_fluorescence)) + geom_point() + labs(x="Chlorophyll", y="Concentration", title="scorpaenidae") + theme_classic()
...
ggplot(data=data.ontogeny, aes(y=conc, x=depth, group=stage, fill=stage)) + stat_summary_bin(fun.y="mean", geom="bar", position=position_dodge(width=0.90)) + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.15),position=position_dodge(width=0.90)) + labs(x="Depth", y="Concentration", title="scorpaenidae") + theme_classic() +coord_flip() +  scale_x_discrete(limits = rev(levels(data.ontogeny$depth)))
...
```{r}
ggplot(data=data.ontogeny, aes(y=conc, x=depth, group=stage, fill=stage)) +facet_grid(~feature) + stat_summary_bin(fun.y="mean", geom="bar", position=position_dodge(width=0.90)) + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.15),position=position_dodge(width=0.90)) + labs(x="Depth", y="Concentration", title="scorpaenidae") + theme_classic()  +  scale_x_discrete(limits = levels(data.ontogeny$depth))
model.ontogeny.featuredepthstage.nb <- glm.nb(count ~ offset(log(volume)) + feature*depth*stage, data=data.ontogeny)
summary(model.ontogeny.featuredepthstage.nb)
...
model.ontogeny.zinb <- zeroinfl(count ~ offset(log(volume)) + depth*stage + temperature.scale, dist="negbin", link="logit", data=data.ontogeny, maxit = 1000)

model.ontogeny.nb <- glm.nb(count ~ offset(log(volume)) + feature*depth*stage + temperature.scale, data=data.ontogeny)

summary(model.ontogeny.zinb)
plot(model.ontogeny.full.olre)

vuong(model.ontogeny.nb,model.ontogeny.zinb )
...
ggplot(data=data.length, aes(total_length)) + geom_histogram() + labs(x="length") + scale_x_sqrt()
```
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=depth, fill="red")) + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Depth", y="Length (mm)", title="scorpaenidae") + theme_classic() + guides(fill="none")
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=stage, fill="red")) + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Stage", y="Length (mm)", title="scorpaenidae") + theme_classic() + guides(fill="none")
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=temperature))+ geom_smooth(method="glm", method.args=list(family = gaussian(link = 'log'))) + geom_point() + labs(x="Temperature", y="Length (mm)", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=salinity)) + geom_point() + labs(x="Salinity", y="Length (mm)", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=chlorophyll_fluorescence)) + geom_point() + labs(x="Chlorophyll", y="Length (mm)", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=dissolved_oxygen)) +geom_smooth(method="glm", method.args=list(family = gaussian(link = 'log')))+ geom_point() + labs(x="Dissolved Oxygen", y="Length (mm)", title="scorpaenidae") + theme_classic()
...
```{r}
ggplot(data=data.length, aes(y=total_length, x=feature, fill="red"))  + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Stage", y="Length (mm)", title="scorpaenidae") + theme_classic() + guides(fill="none")
...
So they were bigger in the eddy
```{r}
ggplot(data=data.length, aes(y=total_length, x=depth, fill="red")) + facet_grid(~feature)  + stat_summary_bin(fun.y="mean", geom="bar") + stat_summary(fun.data = mean_se, geom = "errorbar", aes(width=0.25)) + labs(x="Stage", y="Length (mm)", title="scorpaenidae") + theme_classic() + guides(fill="none")
...
So they were bigger in the eddy
```{r}
summary(model.length.full <- glm(total_length ~ feature+depth, family = gaussian(link="log"), data=data.length))
