...
is_overdispersed(model.ontogeny.featuredepthstage.nb)
...
model.ontogeny.full.nb <- glm.nb(count ~ offset(log(volume)) + feature*stage + depth*stage + do.scale + temperature, data=data.ontogeny, control = glm.control(maxit=200))
summary(model.ontogeny.full.nb)
