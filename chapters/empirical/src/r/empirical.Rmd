...
map <- openmap(c(lat= -26, lon= 150), c(lat= -34, lon= 156), type="osm")
...
map <- g + geom_point(aes(x=longitude, y=latitude, group=site, colour=feature, shape=feature), size=2, data=sites) + theme(legend.position = "top")
