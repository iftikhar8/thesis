...
Where possible, data was derived from figures using the free software package GraphClick (version 3.0.3; http://www.arizona-software.ch/graphclick/). Analysis was conducted using the R programming language {RAlanguageanden:wf}. 
