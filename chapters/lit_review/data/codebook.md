...
Distance_travelled_stdev | The standard deviation of the mean distance travelled by the particles | Km |
...
Dispersion_index | Defined as the sum of of products of the number of particles in each grid cell, multiplied by the straight line distance from the release site and normalised by the total number of particles released | Text | Yes / No
Connectivity_matrix_potential | Was the potential connectivity matrix published in the study, where the potential connectivity matrix defines the probability of connectivity between sites | Text | Yes / No
Connectivity_matrix_realised | Was the realised connectivity matrix published in the study, where the realised connectivity matrix is the potential connectivity matrix, normalised by number of particles released | Text | Yes / No
