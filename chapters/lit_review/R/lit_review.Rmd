...
corrSR <- cor(data.window$window,data.window$Self_recruitment_mean)
...
corrSS <- cor(data.window$window,data.window$Settlement_success_mean)
...
corrLR <- cor(data.window$window,data.window$Local_retention_mean)
