...
comparisons.plot <- ggplot(papers.comparisons, aes(published)) + geom_bar(aes(fill = behaviours)) +labs( x = "", y = "Number of models") +
...
save_plot("../../figs/physical-physical.png",plot=model.p, nrow=2,ncol=2)
